  ...
  <AuthenticatedLayout>
    <template #header>
      <div class="flex items-center justify-between">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">Editar Ejercicio</h2>
      </div>
    </template>
    <div class="py-12">
        ...
        <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
          <div class="p-6">
            <div class="flex justify-between items-center mb-6">
              <h1 class="text-2xl font-bold text-gray-800">Editar Ejercicio</h1>
              <Link href="/exercises" class="bg-gray-200 text-gray-700 px-4 py-2 rounded hover:bg-gray-300">Volver</Link>
            </div>
            <Form :form="form" :types="types" :lessons="lessons" :errors="errors" :onSubmit="submit" :isEdit="true" />
          </div>
        </div>
      </div>
    </div>
