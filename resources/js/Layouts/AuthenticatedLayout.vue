                    ...
                    <template #content>
                        <span class="dropdown-content">
                            <DropdownLink :href="route('profile.edit')">
                                ...
                                <span class="span-logout">Perfil</span></DropdownLink>
                            <DropdownLink :href="route('logout')" method="post" as="button">
                            <img src="/icons/logout-icon.gif" alt="Cerrar sesión" title="Cerrar sesión" class="img-logout">
                            <span class="span-logout">Cerrar sesión</span></DropdownLink>
                        </span>
                    </template>
